...
///
/// `R`, `P`, `S` are rule engine capacity constants.
pub struct TcpProxy<'r, const R: usize, const P: usize, const S: usize> {
...
impl<'r, const R: usize, const P: usize, const S: usize> TcpProxy<'r, R, P, S> {
